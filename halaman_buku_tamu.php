                        ...
                        <?php
                            ...
                            if($result->num_rows> 0){
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                    <a href="proses_delete_buku_tamu.php?idTamu=<?=$row['id_tamu'];?>" title="Hapus" class="btn btn-danger btn-sm">
                                        <i class="fa fa-trash"></i>
                                    </a>
                                    <a href="halaman_edit_buku_tamu.php?idTamu=<?=$row['id_tamu'];?>" title="Ubah" class="btn btn-primary btn-sm">
